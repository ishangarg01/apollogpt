...
//           {!isMobilePreviewOpen ? (
//             // Mobile Chat View
//             <Card className="flex-1 flex flex-col m-2 rounded-2xl border-0 shadow-lg overflow-hidden">
          ...
          {!isMobilePreviewOpen ? (
            ...
            <Card className="flex-1 flex flex-col m-2 rounded-2xl border-0 shadow-lg">
              <CardHeader className="flex-none pb-3">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-lg">Preview</CardTitle>
                  {/* Added mobile-specific controls here */}
                  <div className="flex items-center gap-2">
                    {codeToDisplay && <DownloadButton code={codeToDisplay} />}
                    {codeToDisplay && <CopyButton code={codeToDisplay} />}
                    <Tabs value={isPreviewMode} onValueChange={(value) => setIsPreviewMode(value as PreviewMode)}>
                      <TabsList className="grid w-full grid-cols-2 h-9 rounded-lg">
                        <TabsTrigger value="preview" className="rounded-md p-2">
                          <Eye className="h-4 w-4" />
                        </TabsTrigger>
                        <TabsTrigger value="editor" className="rounded-md p-2">
